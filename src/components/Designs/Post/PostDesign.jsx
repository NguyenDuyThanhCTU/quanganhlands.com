          ...
          <div className=" flex items-center gap-5 py-5 border-b w-[963px]">
            ...
            <div className="w-[508px] font-LexendDeca">
              ...
              <p className="font-light truncate5 mt-3">
                Biệt thụ hiên đang là xu thế phát triển mà mọi người hướng tới
                khi muốn xây dựng tổ ấm cho riêng mình. Nắm bắt xu thế theo nhu
                cầu khách hàng, chúng tôi xin giới thiệu đến quý khách hàng mẫu
                biệt thự sân vườn đẹp ở Đà Lạt.
              </p>
            </div>
          </div>
        </div>
